...
<% 
	...
	String confmKey = "devU01TX0FVVEgyMDIxMDIxODE2MTcxOTExMDgyNzU="; // 검색API 승인키
	String domain = "http://www.juso.go.kr"; // 인터넷망
	// ※ 행정망 내에서 운영되는 시스템도 이용 가능합니다. 행정망 서비스를 위한 API 요청URL은 별도로 문의 주시기 바랍니다.(1588-0061)
	String resultType = "3"; // 검색결과 화면 출력유(1 : 도로명, 2 : 도로명+지번, 3 : 도로명+상세건물명, 4 : 도로명+지번+상세건물명)
%>
<script type="text/javascript" src="${contextPath }/js/openapi/jquery-1.12.4.min.js"></script>
<script type="text/javascript" src="${contextPath }/js/openapi/addrlink.js"></script>
<link rel="stylesheet" type="text/css" href="/cafeinme/css/mycafe/addrlink.css"></link>
