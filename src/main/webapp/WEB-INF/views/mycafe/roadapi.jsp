...
<% 
	...
	String confmKey = "devU01TX0FVVEgyMDIxMDIxNzA5MzgzOTExMDgxODk="; // 검색API 승인키
...
%>
<script type="text/javascript" src="/cafeinme/js/mycafe/jquery-1.12.4.min.js"></script>
<script type="text/javascript" src="/cafeinme/js/mycafe/addrlink.js"></script>
...
<script language="javascript">
	...
	function setParent(){
		...
		opener.jusoCallBack(rtAddrPart1, rtAddrDetail);
